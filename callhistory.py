...
class CallHistory:
    ...
    def register_outgoing_call(self, call: Call) -> None:
        ...
        if (call_month, call_year) not in self.outgoing_calls:
            self.outgoing_calls[(call_month, call_year)] = []
    ...
    def register_incoming_call(self, call: Call) -> None:
        ...
        call_month = call.time.month
        call_year = call.time.year
        if (call_month, call_year) not in self.incoming_calls:
            self.incoming_calls[(call_month, call_year)] = []
